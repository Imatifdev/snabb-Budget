...
class _TransferScreenState extends State<TransferScreen> {
  ...
  try {
    ...
    _amount.clear();
    _notes.clear();
    Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => const HomeScreen(),), ModalRoute.withName('/'),);
          ...
          Padding(
            ...
            child: Form(
              ...
              child: Column(
                ...
                child: Text("Transfer Value", style: TextStyle(
              ...
              hint: const Text('Select account to transfer from'),
              onChanged: (newValue) {
                setState(() {
            ...
            DropdownButton<Account>(
              ...
              hint: const Text('Select account to transfer to'),
              onChanged: (newValue) {
                setState(() {
